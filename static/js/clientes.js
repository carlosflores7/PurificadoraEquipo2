function validar(form){
    var cad='';
    cad=validarPassword(form.password.value);
...
function passwordRobusto(pwd){
    ...
    if(banNumero && banMin && banMay && banCarEs)
        ...
        return 'El password debe tener al menos un digito, una mayuscula, una minuscula y al menos un caracter especial.<br>'
}
